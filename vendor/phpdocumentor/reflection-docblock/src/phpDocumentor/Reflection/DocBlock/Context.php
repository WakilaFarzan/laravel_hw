...
class Context
{
    ...
    /** @var string Name of the structural partials, within the namespace. */
    protected $lsen = '';
     ...
     *     Qualified Namespace.
     * @param string $lsen              Name of the structural partials, within
     *     the namespace.
     */
     ...
     * 
     * @return string Name of the structural partials, within the namespace.
     */
     ...
     * punctuation determining the kind of structural partials (e.g. trailing "("
     * and ")" for functions and methods).
     * 
     * @param string $lsen The new local name of a structural partials.
     * 
     * @return $this
     */
