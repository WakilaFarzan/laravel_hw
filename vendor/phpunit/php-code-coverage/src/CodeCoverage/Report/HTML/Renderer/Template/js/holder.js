...
(function(register, global, undefined) {
	...
	var Holder = {
		...
		/**
		 * Appends a placeholder to an partials
		 *
		 * @param {string} src Placeholder URL string
		 * @param {string} el Selector of target partials(s)
		 */
	...
	/**
	 * Core function that takes output from renderers and sets it as the source or background-image of the target partials
	 *
	 * @private
	 ...
	 *
	 * @private
	 * @param element Optional partials selector, specified only if a specific partials needs to be re-rendered
	 */
	...
	/**
	 * Checks if an partials is visible
	 *
	 * @private
	 * @param el DOM partials
	 * @param callback Callback function executed if the partials is invisible
	 */
	...
	/**
	 * Generic new DOM partials function
	 *
	 * @private
	 ...
	 *
	 * @private
	 * @param el Reference to DOM partials
	...
	/**
	 * Generic SVG partials creation function
	 *
	 * @private
