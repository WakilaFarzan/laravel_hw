...
class PHP_CodeCoverage_Report_Node_Iterator implements RecursiveIterator
{
    ...
    /**
     * Rewinds the Iterator to the first partials.
     *
     */
    ...
    /**
     * Checks if there is a current partials after calls to rewind() or next().
     *
     * @return boolean
     */
    ...
    /**
     * Returns the key of the current partials.
     *
     * @return integer
     */
    public function key()
    ...
    /**
     * Moves forward to next partials.
     *
     */
    ...
    /**
     * Returns the sub iterator for the current partials.
     *
    ...
    /**
     * Checks whether the current partials has children.
     *
     * @return boolean
     */
