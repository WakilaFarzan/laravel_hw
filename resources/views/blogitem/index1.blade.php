						...
						<div class="col-md-12 blog-page">
							...
							<div class="col-md-9 article-block">
									...
									<div>
										...
										<div>
                                    			                    {!! Form::open(array('class' => 'form-inline', 'method' => 'DELETE', 'route' => array('categories.blogs.destroy', $category->title, $blog->title))) !!}

                                    							<p>

                                                                     {!! link_to_route('categories.blogs.show', 'Show Detail', array($category->title, $blog->title), array('class' => 'btn btn-info')) !!}
                                                                      {!! link_to_route('categories.blogs.edit', 'Edit', array($category->title, $blog->title), array('class' => 'btn btn-info')) !!}
